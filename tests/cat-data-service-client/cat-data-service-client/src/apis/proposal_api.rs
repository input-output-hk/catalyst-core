...
pub async fn get_all_proposals(
...
) -> Result<serde_json::Value, Error<GetAllProposalsError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetAllProposalsError> =
...
pub async fn get_proposal(
...
) -> Result<serde_json::Value, Error<GetProposalError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetProposalError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
