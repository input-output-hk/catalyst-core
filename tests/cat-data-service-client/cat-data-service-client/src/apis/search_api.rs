...
pub async fn search(configuration: &configuration::Configuration, limit: Option<serde_json::Value>, offset: Option<serde_json::Value>, total: Option<serde_json::Value>, search_query: Option<crate::models::SearchQuery>) -> Result<crate::models::Search200Response, Error<SearchError>> {
    ...
    if let Some(ref local_var_str) = total {
        local_var_req_builder = local_var_req_builder.query(&[("total", &local_var_str.to_string())]);
    }
