...
function restoreWallet(mnemonics) {
    return new Promise(function (resolve, reject) {
        primitives.walletRestore(mnemonics, function (wallet) {
            resolve(wallet);
        }, function (err) {
            reject(err);
        });
...
function retrieveFunds(wallet, block) {
    return new Promise(function (resolve, reject) {
        primitives.walletRetrieveFunds(wallet, block, function (settings) {
            resolve(settings);
        }, function (err) {
            reject(err);
        });
...
function totalFunds(wallet) {
    return new Promise(function (resolve, reject) {
        primitives.walletTotalFunds(wallet, function (funds) {
            resolve(funds);
        }, function (err) {
            reject(err);
        });
...
function deleteWallet(wallet) {
    return new Promise(function (resolve, reject) {
        primitives.walletDelete(wallet, function () {
            resolve();
        }, function (err) {
            reject(err);
        });
...
function deleteSettings(settings) {
    return new Promise(function (resolve, reject) {
        primitives.settingsDelete(settings, function () {
            resolve();
        }, function (err) {
            reject(err);
        });
