...
pub struct VoteInfo {
    ...
    #[serde(rename = "fragment_id", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    ...
    /// Blockchain ID of the vote plan transaction
    #[serde(rename = "voteplan_id", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "choice", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub choice: Option<Option<serde_json::Value>>,
    /// raw bytes of transaction
    #[serde(rename = "raw_fragment", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
