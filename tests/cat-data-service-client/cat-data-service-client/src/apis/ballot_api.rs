...
pub async fn get_all_ballot_info_per_event(
    configuration: &configuration::Configuration,
    id: serde_json::Value,
) -> Result<serde_json::Value, Error<GetAllBallotInfoPerEventError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetAllBallotInfoPerEventError> =
...
/// Retrieves all necessary information to cast a vote. If not present, they are not yet defined. If not defined, then it is not possible to cast a ballot on this proposal yet.
pub async fn get_all_ballot_info_per_objective(
    configuration: &configuration::Configuration,
    id: serde_json::Value,
    obj_id: serde_json::Value,
) -> Result<serde_json::Value, Error<GetAllBallotInfoPerObjectiveError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetAllBallotInfoPerObjectiveError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_api_v1_ballot_cast_id(
    configuration: &configuration::Configuration,
    id: serde_json::Value,
) -> Result<(), Error<GetApiV1BallotCastIdError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetApiV1BallotCastIdError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
/// Retrieves all necessary information to cast a vote. If not present, they are not yet defined. If not defined, then it is not possible to cast a ballot on this proposal yet.
pub async fn get_ballot_info_per_proposal(
    configuration: &configuration::Configuration,
    id: serde_json::Value,
    obj_id: serde_json::Value,
    prop_id: serde_json::Value,
) -> Result<crate::models::CatalystV1Ballot, Error<GetBallotInfoPerProposalError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetBallotInfoPerProposalError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_ballot_proofs(
    configuration: &configuration::Configuration,
    vkey: serde_json::Value,
    id: serde_json::Value,
    votes_by_vote_caster_and_voteplan_id: crate::models::VotesByVoteCasterAndVoteplanId,
) -> Result<crate::models::VoteInfo, Error<GetBallotProofsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetBallotProofsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn post_api_v1_ballot_check(
    configuration: &configuration::Configuration,
) -> Result<(), Error<PostApiV1BallotCheckError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PostApiV1BallotCheckError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
