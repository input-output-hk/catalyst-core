...
class NodeTaskSchedule(object):
    ...
    # variables added by running tasks
    # connection to db, hard to use typing with
    conn: Any | None = None
    ...
    async def bootstrap_storage(self):
        ...
        Path(self.jorm_config.storage).mkdir(parents=True, exist_ok=True)
