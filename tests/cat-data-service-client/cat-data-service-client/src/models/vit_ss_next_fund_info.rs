...
pub struct VitSsNextFundInfo {
    #[serde(rename = "next", skip_serializing_if = "Option::is_none")]
    pub next: Option<Box<crate::models::VitSsNextFundInfoNext>>,
}

impl VitSsNextFundInfo {
    pub fn new() -> VitSsNextFundInfo {
        VitSsNextFundInfo { next: None }
    }
}
