...
pub struct SearchOrderBy {
    #[serde(rename = "column")]
    pub column: crate::models::SearchColumn,
    #[serde(rename = "descending", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub descending: Option<Option<serde_json::Value>>,
}

impl SearchOrderBy {
    pub fn new(column: crate::models::SearchColumn) -> SearchOrderBy {
        SearchOrderBy {
            column,
            descending: None,
        }
