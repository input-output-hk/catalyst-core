...
/// struct for typed errors of method [`get_objectives`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetObjectivesError {
    Status404(),
...
pub async fn get_objectives(configuration: &configuration::Configuration, limit: Option<serde_json::Value>, offset: Option<serde_json::Value>, grp: Option<serde_json::Value>) -> Result<serde_json::Value, Error<GetObjectivesError>> {
    ...
    let local_var_uri_str = format!("{}/api/v1/event/{id}/objectives", local_var_configuration.base_path);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetObjectivesError> = serde_json::from_str(&local_var_content).ok();
