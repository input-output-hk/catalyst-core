...
use crate::jormungandr::explorer::{
    data::transactions_by_address::{PayloadType as expPayloadType, *},
    verifiers::VerifierError,
};
...
impl ExplorerVerifier {
    pub fn assert_transactions_address(
        ...
        for edges in explorer_transactions.edges.iter() {
            ...
            Self::assert_transactions_address_certificate(node, fragment).unwrap();
        }
    }

    fn assert_transactions_address_certificate(
        explorer_transaction: &TransactionsByAddressTipTransactionsByAddressEdgesNode,
        fragment: &Fragment,
    ) -> Result<(), VerifierError> {
        if explorer_transaction.certificate.is_none() {
            if let Fragment::Transaction(fragment_transaction) = fragment {
                Self::assert_transaction_address_params(fragment_transaction, explorer_transaction)
                    .unwrap();
                Ok(())
            } else {
            ...
            TransactionsByAddressTipTransactionsByAddressEdgesNodeCertificate::StakeDelegation(
                explorer_cert,
            ) => {
            ...
            TransactionsByAddressTipTransactionsByAddressEdgesNodeCertificate::OwnerStakeDelegation(
                explorer_cert,
            ) => {
            ...
            TransactionsByAddressTipTransactionsByAddressEdgesNodeCertificate::PoolRegistration(
                explorer_cert,
            ) => {
            ...
            TransactionsByAddressTipTransactionsByAddressEdgesNodeCertificate::PoolRetirement(
                explorer_cert,
            ) => {
            ...
            TransactionsByAddressTipTransactionsByAddressEdgesNodeCertificate::UpdateProposal(
                explorer_cert,
            ) => {
            ...
            TransactionsByAddressTipTransactionsByAddressEdgesNodeCertificate::MintToken(_) => {
                Err(VerifierError::InvalidCertificate {
                    received: "MintToken can be only in block0".to_string(),
                })
            }
            TransactionsByAddressTipTransactionsByAddressEdgesNodeCertificate::EvmMapping(_) => {
    ...
    fn assert_transaction_address_params<P>(
    ...
    fn assert_address_pool_registration(
        fragment_cert: &Transaction<PoolRegistration>,
        explorer_cert: &TransactionsByAddressTipTransactionsByAddressEdgesNodeCertificateOnPoolRegistration,
    ) {
    ...
    fn assert_address_stake_delegation(
        fragment_cert: &Transaction<StakeDelegation>,
        explorer_cert: &TransactionsByAddressTipTransactionsByAddressEdgesNodeCertificateOnStakeDelegation,
    ) -> Result<(), VerifierError> {
    ...
    fn assert_address_owner_delegation(
        fragment_cert: &Transaction<OwnerStakeDelegation>,
        explorer_cert: &TransactionsByAddressTipTransactionsByAddressEdgesNodeCertificateOnOwnerStakeDelegation,
    ) -> Result<(), VerifierError> {
    ...
    fn assert_address_pool_retirement(
        fragment_cert: &Transaction<PoolRetirement>,
        explorer_cert: &TransactionsByAddressTipTransactionsByAddressEdgesNodeCertificateOnPoolRetirement,
    ) {
    ...
    fn assert_address_pool_update(
        fragment_cert: &Transaction<PoolUpdate>,
        explorer_cert: &TransactionsByAddressTipTransactionsByAddressEdgesNodeCertificateOnPoolUpdate,
    ) {
    ...
    fn assert_address_vote_plan(
        fragment_cert: &Transaction<VotePlan>,
        explorer_cert: &TransactionsByAddressTipTransactionsByAddressEdgesNodeCertificateOnVotePlan,
    ) {
    ...
    fn assert_address_vote_cast(
        fragment_cert: &Transaction<VoteCast>,
        explorer_cert: &TransactionsByAddressTipTransactionsByAddressEdgesNodeCertificateOnVoteCast,
    ) {
    ...
    fn assert_address_vote_tally(
        fragment_cert: &Transaction<VoteTally>,
        explorer_cert: &TransactionsByAddressTipTransactionsByAddressEdgesNodeCertificateOnVoteTally,
    ) {
    ...
    fn assert_address_update_proposal(
        fragment_cert: &Transaction<UpdateProposal>,
        explorer_cert: &TransactionsByAddressTipTransactionsByAddressEdgesNodeCertificateOnUpdateProposal,
    ) {
    ...
    fn assert_address_update_vote(
        fragment_cert: &Transaction<UpdateVote>,
        explorer_cert: &TransactionsByAddressTipTransactionsByAddressEdgesNodeCertificateOnUpdateVote,
    ) {
