...
pub async fn get_all_review_types(configuration: &configuration::Configuration, id: serde_json::Value, obj_id: serde_json::Value, limit: Option<serde_json::Value>, offset: Option<serde_json::Value>) -> Result<serde_json::Value, Error<GetAllReviewTypesError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v1/event/{id}/objective/{obj_id}/review_types", local_var_configuration.base_path, id=id, obj_id=obj_id);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetAllReviewTypesError> = serde_json::from_str(&local_var_content).ok();
...
pub async fn get_proposal_reviews(configuration: &configuration::Configuration, id: serde_json::Value, obj_id: serde_json::Value, prop_id: serde_json::Value, limit: Option<serde_json::Value>, offset: Option<serde_json::Value>) -> Result<serde_json::Value, Error<GetProposalReviewsError>> {
    ...
    let local_var_uri_str = format!("{}/api/v1/event/{id}/objective/{obj_id}/proposal/{prop_id}/reviews", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetProposalReviewsError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
