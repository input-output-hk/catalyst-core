...
pub struct DelegatorInfo {
    ...
    #[serde(rename = "delegations", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub delegations: Option<Option<serde_json::Value>>,
    /// Hex encoded reward address for this delegation.
    #[serde(rename = "reward_address", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub reward_address: Option<Option<serde_json::Value>>,
    /// Raw total voting power from stake address
    #[serde(rename = "raw_power", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub raw_power: Option<Option<serde_json::Value>>,
    /// Total voting power, across all registered voters.
    #[serde(rename = "total_power", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
