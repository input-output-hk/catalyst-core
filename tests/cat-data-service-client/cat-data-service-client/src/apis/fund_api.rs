...
pub async fn get_current_fund(configuration: &configuration::Configuration, ) -> Result<serde_json::Value, Error<GetCurrentFundError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetCurrentFundError> = serde_json::from_str(&local_var_content).ok();
